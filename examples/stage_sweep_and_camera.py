...
from lensrec.tools import ensure_no_overwrite, save_as_8bit_tiff, make_dir
...
if __name__=='__main__':
    ...
    for i, (z, dz) in enumerate(zip(relative_positions_mm, stage_displacements_mm)):
        print("Started acquisition {}/{}".format(i + 1, len(relative_positions_mm)))
        ...
        # ...and save it
        save_as_8bit_tiff(data=cam_image, filename=output_file)

    # move back to the original position
    s1.move_relative(relative_positions_mm[-1])
